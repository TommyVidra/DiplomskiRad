...
from .utils import basic_search_attribute_parse
...
def create_app(test_config=None):
    ...
    def return_dict():
        ...
        json_dictionary_attributes = json.dumps(
            dictionary_attributes, cls=SetEncoder, sort_keys=True, ensure_ascii=False
        )
    ...
    def download_data():
        ...
        file_path = os.path.join(
            os.path.dirname(os.path.realpath(__file__)), "data", "Test.pdf"
        )
        try:
